...
export class InitialMigration1619424824414 implements MigrationInterface {
    name = 'InitialMigration1619424824414'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query("CREATE TABLE `Token` (`id` int NOT NULL AUTO_INCREMENT, `tokenName` varchar(25) NOT NULL, `tokenTicker` varchar(25) NOT NULL, `owner` varchar(100) NOT NULL, `creationDate` date NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
